...
function suggestionsMatched(str, value) {
  ...
  if (Array.isArray(fields)) {
    return function () {
      return fields.reduce((match, field) => {
        ...
        return typeof value === 'string' && suggestionsMatched(str, value)
      }, false)
    }
  }
  ...
  if (deep) {
    return function () {
      let result = deepReduce(this, (match, value) =>
        match || (
          typeof value === 'string' && suggestionsMatched(str, value)
        ), false)
      return result
    }
  }
